...
fv=open('/home/pi/fyp/vrms10.txt','w')
fi=open('/home/pi/fyp/irms10.txt','w')
ffv=open('/home/pi/fyp/fv10.txt','w')
ffi=open('/home/pi/fyp/fi10.txt','w')
fh=open('/home/pi/fyp/d10.txt')
fpf=open('/home/pi/fyp/pf10.txt','w')
fq=open('/home/pi/fyp/q10.txt','w')
fp=open('/home/pi/fyp/p10.txt','w')
fs=open('/home/pi/fyp/s10.txt','w')
fthdv=open('/home/pi/fyp/THDV10.txt','w')
fthdi=open('/home/pi/fyp/THDI10.txt','w')
ftd=open('/home/pi/fyp/td10.txt','w')
fcons=open('/home/pi/fyp/const.txt')
KSSS=fcons.read();


db='/home/pi/fyp/dbb10.py'
z=fh.read()
...
'''.............const of cuurent...................................'''
Vac=[];nn=0;fin=[0,0,0,0,0,0,0,0];
phi=[0,0,0,0,0,0,0,0];vrm=[0,0,0,0,0,0,0,0];vhrm=range(0,625);count=0;nnnn=0;
vhrm[624]=0;
for v in V:
